...
void loop() {
    ...
    // relay
    digitalWrite(dataPin, LOW); //MIC_LINE_LARGE_FADER_INDEX      = 0; LARGE -> LINE
    delay(1);
    digitalWrite(clockPin, LOW);
    ...
    digitalWrite(dataPin, LOW); //BUS_TAPE_LARGE_FADER_INDEX      = 1;
    delay(1);
    digitalWrite(clockPin, LOW);
    // delayMicroseconds(10);
    delay(1);
    ...
    digitalWrite(dataPin, HIGH); //TOGGLE_LARGE_FADER_INDEX        = 2;
    delay(1);
    digitalWrite(clockPin, LOW);
    // delayMicroseconds(10);
    delay(1);
    ...
    digitalWrite(dataPin, LOW); //TOGGLE_NEXT_LARGE_FADER_INDEX   = 3;
    delay(1);
    digitalWrite(clockPin, LOW);
    // delayMicroseconds(10);
    delay(1);
    ...
    digitalWrite(dataPin, LOW); //BUS_TAPE_NEXT_LARGE_FADER_INDEX = 4;
    delay(1);
    digitalWrite(clockPin, LOW);
    // delayMicroseconds(10);
    delay(1);
    ...
    digitalWrite(dataPin, LOW); //MIC_LINE_NEXT_LARGE_FADER_INDEX = 5;
    delay(1);
    digitalWrite(clockPin, LOW);
    // delayMicroseconds(10);
    delay(1);
    ...
    digitalWrite(dataPin, LOW); //MIC_LINE_SMALL_FADER_INDEX      = 6;
    delay(1);
    digitalWrite(clockPin, LOW);
    // delayMicroseconds(10);
    delay(1);
    ...
    digitalWrite(dataPin, LOW); //BUS_TAPE_SMALL_FADER_INDEX      = 7;
        delay(1);
    digitalWrite(clockPin, LOW);
    // delayMicroseconds(10);
    delay(1);
